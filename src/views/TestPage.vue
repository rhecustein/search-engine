...
onMounted(() => {
  window.scroll(0, 0);
  document.title = "Test Page | " + import.meta.env.VITE_TITLE;
});
</script>
...
<template>
  ...
  <main class="mt-4 min-h-[300px]">
    <!-- BEGIN Search Form -->
    <div class="mx-auto mt-[140px] flex max-w-2xl flex-col px-5 lg:px-0">
      <form class="relative w-full" method="post">
        <label for="search-input" class="text-gray-500"
          ...
          ><input
            ...
            placeholder="Type your keywords" /><button
            ...
            type="submit"
          >
            <Icon icon="fe:arrow-right" class="text-xl" /></button
          ><span
